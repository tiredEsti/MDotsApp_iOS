 ...
 *  DotDevice has a property of recording, you can control it after DotDevice connected.
 */
...
/**
 *  The Movella DOT recording file  type class , it has file size and timestamp
 */
@interface DotRecordingFile : NSObject
...
/**
    The Movella DOT recording control class
 */
@interface DotRecording : NSObject
 ...
 */
@property (strong, nonatomic) NSMutableArray <DotRecordingFile *> *files;
