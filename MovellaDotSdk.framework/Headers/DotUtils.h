 ...
 */
@interface DotUtils : NSObject
/**
 * Convert quaternion to euler
 * @param eular The euler array
 * @param quatW The DotPlotData.quatW data
 * @param quatX The DotPlotData.quatX data
 * @param quatY The DotPlotData.quatY data
 * @param quatZ The DotPlotData.quatZ data
 */
